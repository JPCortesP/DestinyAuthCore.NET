...
namespace DestinyAuth.Bungie
{
    public class Tokens
    {
        ...
        public bool Valid
        {
            get
            {
                return (DateTime.Now - Creation).Seconds < AccessToken.Expiration;
            }
        }
        /// <summary>
        ...
        public bool CanRefresh
        {
            ...
            {
                if (!Valid 
                    && (DateTime.Now - Creation).Seconds > RefreshToken.ReadyIn 
                    && (DateTime.Now-Creation).Seconds < RefreshToken.Expiration)
                {
                    return true;
                }
                return false;
